...
import minicraft.item.Special.BeefJerky;
...
public class FoodItem extends StackableItem {
	...
	protected static ArrayList<Item> getAllInstances() {
		...
		items.add(new FoodItem("Bacon", new Sprite(20, 5, Color.get(-1, Color.rgb(220, 0, 0), Color.rgb(255, 137, 137), Color.rgb(255, 150, 150))), 5));
	...
	public FoodItem(String name, Sprite sprite, int heal) { this(name, sprite, 1, heal); }
	public FoodItem(String name, Sprite sprite, int count, int heal) {
