...
public class Items {
	...
	*/
	...
	static {
		...
		addAll(SpecialItems.getAllInstances());
		
		for (LoadedMod mod : Game.getModManager().getModList()) {
			addAll(arrayToList(mod.getItems()));
		}
	}
	
	public static ArrayList<Item> arrayToList(Item[] items) {
