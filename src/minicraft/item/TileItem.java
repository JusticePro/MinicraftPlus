...
public class TileItem extends StackableItem {
	...
	protected static ArrayList<Item> getAllInstances() {
		...
		items.add(new TileItem("Cloud", (new Sprite(2, 4, Color.get(-1, 222, 555, 444))), "cloud", "Infinite Fall", "hole"));
		items.add(new TileItem("Cloud Wall", (new Sprite(2, 4, Color.get(-1, 222, 555, 444))), "cloud wall", "cloud"));
	...
	public boolean interactOn(Tile tile, Level level, int xt, int yt, Player player, int attackDir) {
		...
		else if((model.contains("BRICK") || model.contains("PLANK") || model.contains("SOLID"))) {
