...
public class Recipes {
	...
	public static final ArrayList<Recipe> cloudbenchRecipes = new ArrayList<>();
	public static final ArrayList<Recipe> shrineRecipes = new ArrayList<>();
	...
	static {
		...
		cloudbenchRecipes.add(new Recipe("Cloud_1", "coal_1", "water bucket_1"));
//		cloudbenchRecipes.add(new Recipe("Cloud Wall_2", "Cloud_1"));
		cloudbenchRecipes.add(new Recipe("Cloudbench_1", "Cloud_5"));
		cloudbenchRecipes.add(new Recipe("Shrine_1", "Essence_20"));
		cloudbenchRecipes.add(new Recipe("Cloud Sword_1", "Cloud_10"));
		cloudbenchRecipes.add(new Recipe("Cloud Axe_1", "Cloud_10"));
		cloudbenchRecipes.add(new Recipe("Cloud Hoe_1", "Cloud_10"));
		cloudbenchRecipes.add(new Recipe("Cloud Pickaxe_1", "Cloud_10"));
		cloudbenchRecipes.add(new Recipe("Cloud Shovel_1", "Cloud_10"));
		cloudbenchRecipes.add(new Recipe("Cloud Bow_1", "Cloud_10", "string_2"));
		cloudbenchRecipes.add(new Recipe("Cloud Armor_1", "Cloud_50"));
		
		shrineRecipes.add(new Recipe("Zombie-King Spawn_1", "essence_10", "cloth_10"));
