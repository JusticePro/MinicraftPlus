...
import minicraft.item.Special.PigStaff;
...
public class ToolItem extends Item {
	...
	public static final int MAX_LEVEL = 6; // How many different levels of tools there are
	public static final String[] LEVEL_NAMES = {"Wood", "Rock", "Iron", "Gold", "Gem", "Cloud"}; // The names of the different levels. A later level means a stronger tool.
	...
	public static final int[] LEVEL_COLORS = { // Colors of the tools, same position as LEVEL_NAMES
		...
		Color.get(-1, Color.rgb(240, 240, 240),
				Color.rgb(245, 245, 245), Color.rgb(255, 255, 255)) // cloud
	};
