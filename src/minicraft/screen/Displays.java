...
public class Displays {
	...
	public static final String about =
			"Modded by David.b and +Dillyg10+ until 1.8, then taken over by Chris J. Our goal is to expand Minicraft to be more fun and continuous."
			+ "\nMinicraft was originally made by Markus Perrson for ludum dare 22 competition."
			+ "\n"
			+ "\n"
			+ "2.1.0 and further is being made by JusticePro."
			;
