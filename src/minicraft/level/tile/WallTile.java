...
public class WallTile extends Tile {
	...
	protected WallTile(Material type) {
		...
		switch(type) {
			...
			break;
			case Cloud: sprite = new ConnectorSprite(WallTile.class, new Sprite(4, 25, 3, 3, Color.get(000, Color.rgb(210, 210, 210), Color.rgb(255, 255, 255), Color.rgb(228, 228, 228)), 3), new Sprite(7, 24, 2, 2, Color.get(000, 103), 3), Sprite.blank(2, 2, 103));
			break;
		}
		csprite = sprite;
	}
	...
	public void hurt(Level level, int x, int y, int dmg) {
		...
		if (damage >= sbwHealth) {
			...
			switch(type) {
				...
				case Cloud: itemName = "Cloud Wall"; tilename = "Cloud Wall"; break;
			}
