...
public abstract class MobAi extends Mob {
	...
	/**
	 * The mob dies, is removed from the level and
	 * adds score to all the players in the level this mob is in.
	 * Does not change the current score multiplier.
	 * @param points How much score the players should receive.
	 */
	 ...
	 * adds score to all the players in the level this mob is in.
	 * @param points How much score the players should receive.
	 * @param multAdd How much the score multiplier should change. This change will not 
	 * affect how many points is added in the same call.
	 */
